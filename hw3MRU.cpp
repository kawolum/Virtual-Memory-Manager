		...
		//	sendrequest(readrequest(request1), request2);
			...
			if (!inframes)
			{
				...
				if (mru[pi].size()<r)
				{
					//has free
				//	cout << "hf" << endl;
					mru[pi].push_front(addr.substr(0, segmentnumber + pagenumber));
			...
			//		cout << pagetable[pi][segi][pagi] << endl;
				...
				//	cout << "pr" << endl;
					...
					int segi2 = bintodec(atoi(mru[pi].front().substr(0, segmentnumber).c_str()));
					int pagi2 = bintodec(atoi(mru[pi].front().substr(segmentnumber, pagenumber).c_str()));
					mru[pi].pop_front();
			...
			//	cout << "in frame" << endl;
				//	cout << "page management signals semaphore 1, main" << endl;
				mru[pi].remove(addr.substr(0, segmentnumber + pagenumber));
				mru[pi].push_front(addr.substr(0, segmentnumber + pagenumber));
